    ...
    <section id="about" className="py-24">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <motion.div initial={{ opacity: 0, scale: 0.98 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-4 text-gray-300">A Kaben nasceu da interseção entre dados, inteligência artificial e estratégia de negócio. Nosso propósito é ajudar empresas a transformar dados e processos em eficiência, inteligência e resultado.</p>
          ...
          <div className="mt-8 flex items-center justify-center gap-6">
            ...
            <div className="text-left">
              ...
              <div className="font-semibold">Data • AI • Automation</div>
            </div>
            <div className="text-left">
              <div className="text-xs text-gray-400">Metodologia</div>
              <div className="font-semibold">Orientada a processos e dados</div>
            </div>
          </div>
        </motion.div>
      </div>
